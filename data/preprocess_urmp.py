...
def process_video(video_path, audio_sources, name, indices, source_names, chunk_duration=5):
    """
    Pre-processes video from URMP dataset by slicing into chunks and saving into output folder.

    Args:
        video_path (str): Path to video.
        audio_sources (list): List of ndarray audio sources.
        name (str): Name of the original data point as prefix of the new one.
        indices (tuple): Indices of the audio sources from the original data point.
        source_names (str): Short names of stems from original data point.
